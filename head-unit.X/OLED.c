...
void OLED_cmd(uint8_t cmd) {
    I2C1_Write1ByteRegister(OLED_ADDR, 0x00, cmd);
}
...
void OLED_init(void) {
    ...
    OLED_cmd(0x09);  //extended function set (4-lines)
    ...
    OLED_cmd(0x10);  //set SEG pins ... NOTE: When using NHD-0216AW-XB3 or NHD_0216MW_XB3 change to (0x00)
